...
description: 'Complete API reference for @attestprotocol/stellar-sdk'
---
...
Programmatic access: `getContractId(network, version?)` from `@attestprotocol/stellar-sdk`, or `GET /api/contracts` on horizon.
